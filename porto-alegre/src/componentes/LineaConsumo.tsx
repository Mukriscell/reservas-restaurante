...
export const LineaConsumo = memo(function LineaConsumo({
  ...
  return (
    <li className="flex items-center gap-2 py-2.5">
      ...
      <span className="min-w-[4.5rem] text-right text-sm font-semibold text-amber-400">
      ...
      {!bloqueada && (
        <button
          ...
          className="rounded-lg p-1.5 text-stone-500 hover:bg-red-500/10 hover:text-red-400"
        >
